            ...
            for i in range(len(self.emailStatusMetadata.email_metadata_list)):
                ...
                if email_status.position == position:
                    ...
                    if email_headers is not None:
                        ...
                        self.emailStatusMetadata.email_metadata_list[i].isRead = True
        ...
        with self.mutex:
            for i in range(len(self.emailStatusMetadata.email_metadata_list)):
                ...
                if index == email_status.position:
                    ...
                    result = deleteRemoteEmail(self.generalConfig, self.emailStatusMetadata, index, deleteLocalCopy)
                    if result == True:
                ...
                if email_status.isPendingRemoval == True:
                    pending_result = deleteRemoteEmail(self.generalConfig, self.emailStatusMetadata, email_status.position, deleteLocalCopy)
